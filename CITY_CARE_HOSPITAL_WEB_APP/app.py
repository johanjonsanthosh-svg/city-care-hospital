...
def doctors_page():
    body = """
    <div class="header"><div><h1>Doctor Directory</h1><p>Doctors available at City Care Hospital.</p></div><a class="btn" href="{{ url_for('home') }}">Back Home</a></div>
    ...
    """
    return page("Doctors", body, doctors=doctors)
...
def departments_page():
    ...
    body = """
    <div class="header"><div><h1>Departments</h1><p>Hospital departments and their doctors.</p></div><a class="btn" href="{{ url_for('home') }}">Back Home</a></div>
    <div class="grid">
    ...
    """
    return page("Departments", body, departments=departments, doctors=doctors)
...
def patient_portal():
    ...
    <div class="grid">
      <div class="card"><h3>View Doctors</h3><p>Browse available doctors and departments.</p><a class="btn" href="{{ url_for('doctors_page') }}">Open</a></div>
      <div class="card"><h3>View Departments</h3><p>See hospital departments.</p><a class="btn" href="{{ url_for('departments_page') }}">Open</a></div>
